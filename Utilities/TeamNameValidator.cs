...
namespace Simulator.Utilities
{
    ...
    {
        private const string NamePattern = "^[a-zA-Z0-9 ]{4,14}$";
        ...
        public string ErrorMessage => "Team name must be between 4 and 14 characters long and only contain alphanumeric characters.";
    }
}